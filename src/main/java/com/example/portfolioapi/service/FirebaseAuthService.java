...
public class FirebaseAuthService {
    ...
    public boolean isAdmin(FirebaseToken token) {
        ...
        // Se nenhuma lista de admin foi configurada em ambiente de desenvolvimento, permite qualquer token autenticado com aviso
        if (adminEmails.isEmpty() && adminUids.isEmpty()) {
            log.warn("Operação permitida em modo desenvolvimento (nenhum ADMIN_EMAILS restrito). Configure ADMIN_EMAILS para produção.");
            return true;
        }
